<template>
    <div class="recharge">
        <my-header title="提现记录" :border="border"></my-header>
        <div class="recharge__list">
            <div class="bubble-box" :style="{'top':top + 'px'}">
                <bubble :y="bubbleY"></bubble>
            </div>
            <scroll class="scroll-box" style="padding:0 .3rem" :data="list" :pullup="pullup" @scrollToEnd="loadBottom" :pulldown="pulldown" @pulldown="loadTop" :listenScroll="listenScroll" @scroll="scroll" :canScroll="canScroll">
                <div class="scroll-wrapper">
                    <div class="recharge__item" v-for="(item,index) in list" :key="index">
                        ...
                        <div v-if="item.status == 0" class="recharge__item__status--success">等待提现</div>
