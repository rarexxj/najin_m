<template>
    <div :class="['header ',fix?'fix':'',transparent?'transparent':'',border?'border':'']">
        <div class="header__back" @click="back()"></div>
...
.header {
    ...
    &.transparent {
        background: none;
        .header__back {
            background: url('../../assets/img/header_white_back.png') no-repeat center center;
            background-size: .15rem .25rem;
        }
        .header__title {
            color: #fff;
